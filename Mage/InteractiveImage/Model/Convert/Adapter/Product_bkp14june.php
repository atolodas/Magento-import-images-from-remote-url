...
class Mage_InteractiveImage_Model_Convert_Adapter_Product extends Mage_Catalog_Model_Convert_Adapter_Product
{
    ...
    public function saveRow(array $importData)
    {
		...
		$imageName = Mage::getBaseDir('media') . DS . 'import'. DS .$imageN;
	...
	//	Mage::getBaseDir('media') . DS . 'import'. DS . $imageN;
		$product->addImageToMediaGallery($imageName, $mediaAttribute, false, false);
